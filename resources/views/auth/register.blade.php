                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label">Město</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label">Ulice</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">Heslo znovu</label>
